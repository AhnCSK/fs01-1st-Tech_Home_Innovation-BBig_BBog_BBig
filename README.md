...
| **전등/창문 제어**   | 구현 성공             | 센서 데이터 처리 및 명령 반응속도 개선 필요      | 데이터 처리 로직 최적화                    | 🟡 하 |
| **침입자 감지 팝업**  | 구현 성공             | 센서 데이터 처리 실시간 반응 향상 필요            | 데이터 처리 알고리즘 최적화                  | 🟡 하 |
| **화재 감지 팝업**   | 구현 성공             | 센서 데이터 처리 실시간 반응 향상 필요            | 데이터 처리 코드 개선                     | 🟡 하 |
