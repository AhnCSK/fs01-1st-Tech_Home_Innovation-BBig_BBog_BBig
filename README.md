...
| **문제5: 마트 물품 구입 기능 미구현** | 관련 테이블 및 결제/구매 로직 미설계      | 마트 테이블 생성, 구매/결제 기능 구현            |
...
| 전등/창문 제어  | 성공              | 센서 데이터 처리 및 명령 전달 지연        | 비동기 처리 구현, 센서 데이터 처리 최적화          | 센서 데이터 처리 및 명령 전달 딜레이 감소 | 🟡 낮음 |
| 침입자 감지    | 성공              | 센서 데이터 처리 지연                | 센서 데이터 처리 최적화          | 코드 최적화    | 🟡 낮음 |
| 화재 감지     | 성공              | 센서 데이터 처리 지연                | 센서 데이터 처리 최적화          | 코드 최적화    | 🟡 낮음 |
